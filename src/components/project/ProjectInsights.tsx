  ...
  return (
    <Card className="glass-effect overflow-hidden">
      <CardHeader className="overflow-hidden">
        <CardTitle className="text-xl truncate">Key Insights</CardTitle>
      </CardHeader>
      <CardContent className="overflow-hidden">
        <Tabs defaultValue="insights">
          <TabsList className="mb-6 backdrop-blur-sm bg-background/30 overflow-x-auto flex w-full no-scrollbar">
          ...
          <TabsContent value="insights" className="mt-0 overflow-hidden">
            <ul className="space-y-3 max-h-[400px] overflow-y-auto scrollbar-thin pr-2">
              {keyInsights.map((insight, index) => (
                <li key={index} className="flex items-start gap-3 bg-primary/5 p-3 rounded-lg backdrop-blur-sm">
                  <span className="text-primary mt-1 flex-shrink-0">•</span>
                  <span className="text-sm break-words line-clamp-3">{insight}</span>
                </li>
              ))}
            </ul>
          </TabsContent>
          
          <TabsContent value="swot" className="mt-0 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card className="border-green-200/50 bg-green-50/50 dark:bg-green-950/30 dark:border-green-900/20 backdrop-blur-sm overflow-hidden">
                <CardContent className="p-4 overflow-hidden">
                  <h3 className="font-medium text-green-800 dark:text-green-300 mb-2 truncate">Strengths</h3>
              ...
              <Card className="border-red-200/50 bg-red-50/50 dark:bg-red-950/30 dark:border-red-900/20 backdrop-blur-sm overflow-hidden">
                <CardContent className="p-4 overflow-hidden">
                  <h3 className="font-medium text-red-800 dark:text-red-300 mb-2 truncate">Weaknesses</h3>
                  <ul className="space-y-2 overflow-hidden">
              ...
              <Card className="border-blue-200/50 bg-blue-50/50 dark:bg-blue-950/30 dark:border-blue-900/20 backdrop-blur-sm overflow-hidden">
                <CardContent className="p-4 overflow-hidden">
                  <h3 className="font-medium text-blue-800 dark:text-blue-300 mb-2 truncate">Opportunities</h3>
                  <ul className="space-y-2 overflow-hidden">
              ...
              <Card className="border-amber-200/50 bg-amber-50/50 dark:bg-amber-950/30 dark:border-amber-900/20 backdrop-blur-sm overflow-hidden">
                <CardContent className="p-4 overflow-hidden">
                  <h3 className="font-medium text-amber-800 dark:text-amber-300 mb-2 truncate">Threats</h3>
                  <ul className="space-y-2 overflow-hidden">
          ...
          <TabsContent value="positioning" className="mt-0 overflow-hidden">
            <div className="h-[300px] flex items-center justify-center bg-background/20 rounded-xl backdrop-blur-sm overflow-hidden">
