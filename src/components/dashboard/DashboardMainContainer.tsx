...
import { DashboardContainerData, ProjectStatusData, ProjectCompletionData, DashboardProject } from "@/types/dashboard";
...
const mockProjectCompletionData: ProjectCompletionData[] = [
...
export default function DashboardMainContainer() {
    ...
    const fetchData = async () => {
      try {
        ...
        setData({
          ...
          projectTrends: mockProjectTrendData,
          projectStatus: mockProjectStatusData,
          projectCompletion: mockProjectCompletionData,
  ...
  return <DashboardMainPresenter {...data} />;
}
